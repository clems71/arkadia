...
USB_HID_JOYSTICK_REPORT_WR __attribute__ ((coherent, aligned(4))) joystickReport = {0};
USB_HID_JOYSTICK_REPORT_RD __attribute__ ((coherent, aligned(4))) joystickReportRd = {0};
