...
void main()
{
    ...
    vec3 _res1;
    vec3 _res2;
    _TMP0 = texture2D(tex0, xyp_1_2_3.xw);
    _TMP1 = texture2D(tex0, xyp_1_2_3.yw);
    _TMP2 = texture2D(tex0, xyp_1_2_3.zw);
    _TMP3 = texture2D(tex0, xyp_6_7_8.xw);
    _TMP4 = texture2D(tex0, xyp_6_7_8.yw);
    _TMP5 = texture2D(tex0, xyp_6_7_8.zw);
    _TMP6 = texture2D(tex0, xyp_11_12_13.xw);
    _TMP7 = texture2D(tex0, xyp_11_12_13.yw);
    _TMP8 = texture2D(tex0, xyp_11_12_13.zw);
    _TMP9 = texture2D(tex0, xyp_16_17_18.xw);
    _TMP10 = texture2D(tex0, xyp_16_17_18.yw);
    _TMP11 = texture2D(tex0, xyp_16_17_18.zw);
    _TMP12 = texture2D(tex0, xyp_21_22_23.xw);
    _TMP13 = texture2D(tex0, xyp_21_22_23.yw);
    _TMP14 = texture2D(tex0, xyp_21_22_23.zw);
    _TMP15 = texture2D(tex0, xyp_5_10_15.xy);
    _TMP16 = texture2D(tex0, xyp_5_10_15.xz);
    _TMP17 = texture2D(tex0, xyp_5_10_15.xw);
    _TMP18 = texture2D(tex0, xyp_9_14_9.xy);
    _TMP19 = texture2D(tex0, xyp_9_14_9.xz);
    _TMP20 = texture2D(tex0, xyp_9_14_9.xw);
